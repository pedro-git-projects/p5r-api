...
ARCANA2_COMBOS = [
    ...
    {"source": ["Magician", "Emperor"], "result": "Hanged"},
    ...
    {"source": ["Lovers", "Hanged"], "result": "Sun"},
    ...
    {"source": ["Hanged", "Moon"], "result": "Strength"},
...
SPECIAL_COMBOS = [
    ...
    {
        "result": "Satanael",
        "sources": ["Arsène", "Anzu", "Ishtar", "Satan", "Lucifer", "Michael"],
    },
...
FUSION_CHART = {
    ...
    "table": [
        ...
        ["Moon", "Temperance", "-"],
        ["Hanged", "Justice", "Emperor", "-"],
        ["Temperance", "Faith", "Empress", "Justice", "-"],
        ["Hermit", "Death", "Magician", "Fool", "Fortune", "-"],
        ["Chariot", "Devil", "Fortune", "Judgement", "Fool", "Strength", "-"],
        ["Moon", "Priestess", "Hierophant", "Star", "Faith", "Star", "Temperance", "-"],
        [
            "Star",
            "Emperor",
            "Death",
